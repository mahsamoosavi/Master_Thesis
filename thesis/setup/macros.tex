...
\newcommand{\Signk}[2]{\mathsf{Sign}_{#1}(#2)}
\newcommand{\Verifyk}[2]{\mathsf{Verify}_{#1}(#2)}

\newcommand{\SP}{$\Sigma$-protocol\xspace}
...
% = = = Name
\newcommand{\Ghazal}{\textsf{Ghazal}\xspace}
\newcommand{\Ghazalstar}{\textsf{Ghazal$^\ast$}\xspace}
\newcommand{\UA}{uni-authoritative\xspace}

% = = = URLS
\newcommand{\GhazalCode}{\url{https://github.com/mahsamoosavi/Ghazal}}
